...
# the url below names a placeholder version and sha256 is unset by design —
# both are filled in at submission time (homebrew-core requires
# build-from-source formulas, so this cannot be generated by GoReleaser the
# way the tap formula is).
#
