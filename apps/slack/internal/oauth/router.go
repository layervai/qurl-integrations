...
//
// The Slack workspace install side is handled by apps/slack/cmd's
// /slack/install routes. This package owns the qURL account connection only:
// the API key it stores is the qURL key the bot uses to call qurl-service on
