...
// their own provenance/copy and must not be mislabeled as LLM-generated.
const agentLLMReplyDisclaimer = "\n\n_Generated by an LLM (Anthropic Claude). It may contain mistakes; review before acting._"
