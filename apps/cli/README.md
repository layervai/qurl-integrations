...
```
level=WARN msg="connector: lost the tunnel connection after it was admitted and cannot re-establish it yet; still retrying, and consumers will time out until it recovers" event=reconnect_retrying dial_attempts=2 gives_up_after_seconds=90
```
