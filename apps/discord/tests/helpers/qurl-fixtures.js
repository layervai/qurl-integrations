...
// known-answer test. The public key is public KAT material with no live resource
// behind it. These fixtures cover accepted shapes only; this repo does not
// verify the CRID's derivation from the public key. Keep their shapes
