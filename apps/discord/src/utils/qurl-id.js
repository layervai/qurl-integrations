...
// #1553 accepts at most 10 qurl_ids in a <=4 KiB request. Current qurl-service
...
// Current upstream IDs are exactly q_ + 11 lowercase hex chars. Keep cleanup
...
// TODO(upstream-contract): delegated results use q_ + 11 lowercase hex as
// resourceId in Discord rows; public sends retain their source key/CRID.
function isDelegatedQurlId(value) {
  return typeof value === 'string' && /^q_[0-9a-f]{11}$/.test(value);
}
