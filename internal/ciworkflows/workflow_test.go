...
type step struct {
	...
	Uses  string `yaml:"uses"`
	// TimeoutMinutes is pinned for network bootstrap steps whose job-level
	// timeout is too broad to distinguish setup failure from a test hang.
